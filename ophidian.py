...
icon = pygame.image.load('D:\Annesha\VSCode\Python\Ophidian\icon.png')
...
img = pygame.image.load('D:\Annesha\VSCode\Python\Ophidian\Snake head.png')
direction = 'right'
head = img
apple = pygame.image.load('D:/Annesha/VSCode/Python/Ophidian/apple.png')
